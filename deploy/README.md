...
স্ক্রিপ্ট নিজেই টানেল খোলে, URL ধরে, `.env`-এ বসায়, সার্ভার চালু করে, আর
Ctrl+C-তে সব আগের অবস্থায় ফিরিয়ে দেয় (`.env` ও `domains` টেবিল সহ)।
...
- **মেশিন বন্ধ = সাইট বন্ধ।** ল্যাপটপ ঘুমালে টানেলও যায়।
